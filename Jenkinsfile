pipeline {
    ...
    stages {
      stage('CI Build and push snapshot') {
        ...
        steps {
          dir ('/home/jenkins/go/src/github.com/chrispickard/simple-service') {
            checkout scm
            container('go') {
              sh "make linux"
          ...
          dir ('/home/jenkins/go/src/github.com/chrispickard/simple-service/charts/preview') {
            container('go') {
              sh "make preview"
      ...
      stage('Build Release') {
        ...
        steps {
          container('go') {
            ...
            dir ('/home/jenkins/go/src/github.com/chrispickard/simple-service/charts/simple-service') {
